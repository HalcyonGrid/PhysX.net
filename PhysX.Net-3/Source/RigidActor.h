...
namespace PhysX
{
	...
	public ref class RigidActor abstract : Actor
	{
		...
		public:
			...
			/// <summary>
			/// Manually track a shape associated with this actor but created by physx
			/// </summary>
			...
			/// <summary>
			/// Called on this actor to notify it when one of its shapes has been removed
			/// </summary>
			virtual void ChildShapeRemoved(LinkedListNode<Shape^>^ shape);
