...
namespace PhysX
{
	...
	public ref class StreamExtensions abstract sealed
	{
		internal:
			...
			static void CopyData(System::IO::Stream^ stream, int offsetInBytes, int strideSize, array<T>^ data, int startIndex, int elementCount, bool isSetting);

		public:
			/// <summary>Gets all the data from the begining of the stream (Position 0)</summary>
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static array<T>^ GetData(System::IO::Stream^ stream);
			/// <summary>Gets all the data from the begining of the stream (Position 0)</summary>
			/// <param name="data">An array of structs to copy the data into</param>
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static void GetData(System::IO::Stream^ stream, array<T>^ data);
			/// <summary>Gets all the data from the begining of the stream (Position 0)</summary>
			/// <param name="data">An array of structs to copy the data into</param>
			...
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static void GetData(System::IO::Stream^ stream, array<T>^ data, int startIndex, int elementCount);
			/// <summary>Gets all the data from the begining of the stream (Position 0)</summary>
			...
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static void GetData(System::IO::Stream^ stream, int offsetInBytes, int strideSize, array<T>^ data, int startIndex, int elementCount);

			generic<typename T> where T: value class
			[ExtensionAttribute]
			static void SetData(System::IO::Stream^ stream, array<T>^ data);
			generic<typename T> where T: value class
			[ExtensionAttribute]
			static void SetData(System::IO::Stream^ stream, array<T>^ data, int startIndex, int elementCount);
			generic<typename T> where T: value class
			[ExtensionAttribute]
			static void SetData(System::IO::Stream^ stream, int offsetInBytes, int strideSize, array<T>^ data, int startIndex, int elementCount);

			/// <summary>Reads the next element (T) from the stream and advances the stream Position by the size of T</summary>
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static T Read(System::IO::Stream^ stream);
			...
			generic<typename T> where T : value class
			[ExtensionAttribute]
			static void Write(System::IO::Stream^ stream, T data);
	};
};